...
class BiodiversityController extends Controller
{
    ...
    public function compare(Request $request)
    {
        ...
        foreach ($biodiversities as $biodiversity) {
            $accomplishments = $biodiversity->accomplishment ?? [];
            $years = $biodiversity->years ?? [];
            $officeIds = $biodiversity->office_id ?? [];
            $universe = $biodiversity->universe ?? [];
            ...
            // Get all unique years from this record
            if (is_array($years)) {
            ...
            // Calculate accomplishments for each office
        ...
        return view('sectors.biodiversity.compare', compact(
            'year1',
            'year2',
            'year1Total',
            'year2Total',
