...
@section('content')
        ...
        <div class="bg-gradient-to-r from-rose-600 to-rose-700 text-white p-4">
            <div class="flex items-center justify-between">
                <div class="flex items-center">
                    ...
                    <h2 class="text-lg font-bold">NRA Year Comparison</h2>
                </div>
                <a href="{{ route('nra.index') }}" class="bg-white/20 hover:bg-white/30 text-white px-4 py-2 rounded-lg transition-all duration-200 text-sm font-medium">
        ...
        <div class="p-4">
            <div class="flex items-center space-x-4">
                <div class="flex-1">
                    ...
                    <select id="year1" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-rose-500">
                ...
                <div class="flex-1">
                    ...
                    <select id="year2" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-rose-500">
                        @foreach($allYears as $year)
                ...
                <div class="pt-6">
                    <button onclick="updateComparison()" class="bg-rose-600 hover:bg-rose-700 text-white px-6 py-2 rounded-lg transition-all duration-200 text-sm font-medium">
    ...
    <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden mb-6">
        <div class="p-4">
            <div class="flex items-center space-x-4">
                <button onclick="showChartView()" id="chartViewBtn" class="flex-1 bg-rose-600 text-white px-4 py-2 rounded-lg transition-all duration-200 text-sm font-medium">
    ...
    <div id="chartView" class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden mb-6 {{ request()->has('year1') && request()->has('year2') ? '' : 'hidden' }}">
        <div class="p-4">
            <h3 class="text-lg font-bold text-gray-800 mb-4">
                <i class="fas fa-chart-bar mr-2 text-rose-600"></i>
    ...
    <div id="tableView" class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden mb-6 hidden {{ request()->has('year1') && request()->has('year2') ? '' : 'hidden' }}">
        <div class="p-4">
            <h3 class="text-lg font-bold text-gray-800 mb-4">
                <i class="fas fa-table mr-2 text-rose-600"></i>
                Accomplishment Comparison: {{ $year1 }} vs {{ $year2 }}
            </h3>
                ...
                <tbody>
                    <tr class="bg-rose-50">
                        <td class="border border-gray-300 px-4 py-2 text-sm font-bold">
                            <i class="fas fa-globe mr-2 text-rose-600"></i>With Universe
                        ...
                        <td class="border border-gray-300 px-4 py-2 text-sm text-right font-bold text-rose-600">
                            @if($year2Total > 0)
                    ...
                    <tr class="bg-rose-50">
                        ...
                        <td class="border border-gray-300 px-4 py-2 text-sm text-right font-bold text-rose-600">100%</td>
                    </tr>
                </tbody>
            </table>
            
            <!-- Summary Section -->
            <div class="mt-4 p-3 bg-gradient-to-r from-rose-50 to-pink-50 rounded-lg border border-rose-200">
                <h4 class="text-sm font-bold text-gray-700 mb-2">
                    <i class="fas fa-info-circle mr-2 text-rose-600"></i>Key Insights
                </h4>
    ...
    <script>
        ...
        function updateComparison() {
            ...
            window.location.href = '{{ route('nra.compare') }}?year1=' + year1 + '&year2=' + year2;
        }
        ...
        function showChartView() {
            ...
            document.getElementById('chartViewBtn').classList.add('bg-rose-600', 'text-white');
            document.getElementById('tableViewBtn').classList.remove('bg-rose-600', 'text-white');
        ...
        function showTableView() {
            ...
            document.getElementById('tableViewBtn').classList.add('bg-rose-600', 'text-white');
            document.getElementById('chartViewBtn').classList.remove('bg-rose-600', 'text-white');
