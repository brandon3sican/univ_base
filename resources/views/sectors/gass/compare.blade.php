...
@php
    $pageTitle = 'GASS - Year Comparison';
@endphp
...
@section('content')
        ...
        <div class="bg-gradient-to-r from-blue-600 to-blue-700 text-white p-4">
            <div class="flex items-center justify-between">
                <div class="flex items-center">
                    ...
                    <h2 class="text-lg font-bold">GASS Year Comparison</h2>
                </div>
                <a href="{{ route('gass.index') }}" class="bg-white/20 hover:bg-white/30 text-white px-4 py-2 rounded-lg transition-all duration-200 text-sm font-medium">
        ...
        <div class="p-4">
            <div class="flex items-center space-x-4">
                <div class="flex-1">
                    ...
                    <select id="year1" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
                ...
                <div class="flex-1">
                    ...
                    <select id="year2" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
                        @foreach($allYears as $year)
                ...
                <div class="pt-6">
                    <button onclick="updateComparison()" class="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-lg transition-all duration-200 text-sm font-medium">
    ...
    <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden mb-6">
        <div class="p-4">
            <div class="flex items-center space-x-4">
                <button onclick="showChartView()" id="chartViewBtn" class="flex-1 bg-blue-600 text-white px-4 py-2 rounded-lg transition-all duration-200 text-sm font-medium">
            ...
            <table class="w-full border-collapse border border-gray-300">
                ...
                <tbody>
                    ...
                    <tr class="bg-blue-50">
                        ...
                        <td class="border border-gray-300 px-4 py-2 text-sm text-right font-bold text-blue-600">100%</td>
                    </tr>
                </tbody>
            </table>
    ...
    <script>
        ...
        function updateComparison() {
            ...
            window.location.href = '{{ route('gass.compare') }}?year1=' + year1 + '&year2=' + year2;
        }
        ...
        function showChartView() {
            ...
            document.getElementById('chartViewBtn').classList.add('bg-blue-600', 'text-white');
        ...
        function showTableView() {
            ...
            document.getElementById('chartViewBtn').classList.remove('bg-blue-600', 'text-white');
