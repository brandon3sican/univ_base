<script>
    ...
    function collectRemarks() {
        const formData = new FormData(document.getElementById('gassForm'));
        const remarksValues = [];
    ...
    function openCreateModal() {
        ...
        document.getElementById('gassForm').reset();
        document.getElementById('recordId').value = '';
        document.getElementById('gassModal').classList.remove('hidden');
        document.getElementById('gassModal').classList.add('flex');
    ...
    function closeModal() {
        document.getElementById('gassModal').classList.add('hidden');
        document.getElementById('gassModal').classList.remove('flex');
        document.getElementById('gassForm').reset();
        resetFormSteps();
    }
    ...
    document.addEventListener('DOMContentLoaded', function () {
        const gassForm = document.getElementById('gassForm');
        if (gassForm) {
            gassForm.addEventListener('submit', async function (e) {
                e.preventDefault();
                ...
                const url = recordId ? `/gass/${recordId}/update` : '/gass/store';
                const method = 'POST';
