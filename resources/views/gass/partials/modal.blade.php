<!-- Create/Edit Modal -->
<div id="gassModal" class="fixed inset-0 bg-black bg-opacity-50 z-50 hidden flex items-center justify-center p-4">
    <div class="bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        <div class="bg-gradient-to-r from-blue-600 to-indigo-600 text-white p-6 rounded-t-2xl">
            <div class="flex items-center justify-between">
                <h3 id="modalTitle" class="text-xl font-bold">Add New GASS Record</h3>
        ...
        <form id="gassForm" class="p-6 space-y-4">
            ...
            <div id="step3" class="hidden space-y-4">
                ...
                @php
                    function getHierarchicalNumberForRecord($record)
                    {
                        ...
                        $allRecords = \App\Models\Gass::orderBy('order_column')->get();
