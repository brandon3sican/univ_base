        ...
        <div class="bg-gradient-to-r from-slate-700 to-slate-800 text-white p-6 shadow-lg">
            <div class="flex items-center justify-between">
                <div class="flex items-center">
                    ...
                    <h2 class="text-lg font-bold">ENF Data Table</h2>
                </div>
...
@include('enf.partials.toggle')
@include('enf.partials.modal', ['offices' => $offices ?? [], 'ppas' => $ppas ?? []])
...
<script>
    ...
    document.getElementById('crudForm').addEventListener('submit', function(e) {
        ...
        if (data.ppa_id === 'new') {
            ...
            submitFormData.append('types_id', '3'); // Default type - controller can adjust if needed
