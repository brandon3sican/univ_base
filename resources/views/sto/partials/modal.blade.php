<!-- Create/Edit Modal -->
<div id="stoModal" class="fixed inset-0 bg-black bg-opacity-50 z-50 hidden flex items-center justify-center p-4">
    <div class="bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        <div class="bg-gradient-to-r from-blue-600 to-indigo-600 text-white p-6 rounded-t-2xl">
            <div class="flex items-center justify-between">
                <h3 id="modalTitle" class="text-xl font-bold">Add New STO Record</h3>
        ...
        <form id="stoForm" class="p-6 space-y-4">
            ...
            <div id="step3" class="hidden space-y-4">
                ...
                @php
                    function getHierarchicalNumberForRecord($record)
                    {
                        ...
                        $allRecords = \App\Models\Sto::orderBy('order_column')->get();
                ...
                <div id="additional_fields" class="hidden space-y-4">
                    ...
                    <div>
                        ...
                        <div class="space-y-2">
                            <label class="flex items-center">
                                <input type="checkbox" name="office[]" value="RO"
                                    class="mr-2 rounded border-gray-300 text-blue-600 focus:ring-blue-500">
                                <span class="text-sm">RO</span>
                            </label>
                            <label class="flex items-center">
                                <input type="checkbox" name="office[]" value="ABRA"
                                    class="mr-2 rounded border-gray-300 text-blue-600 focus:ring-blue-500">
                                <span class="text-sm">ABRA</span>
                            </label>
                            <label class="flex items-center">
                                <input type="checkbox" name="office[]" value="APAYAO"
                                    class="mr-2 rounded border-gray-300 text-blue-600 focus:ring-blue-500">
                                <span class="text-sm">APAYAO</span>
                            </label>
                            <label class="flex items-center">
                                <input type="checkbox" name="office[]" value="BENGUET"
                                    class="mr-2 rounded border-gray-300 text-blue-600 focus:ring-blue-500">
                                <span class="text-sm">BENGUET</span>
                            </label>
                            <label class="flex items-center">
                                <input type="checkbox" name="office[]" value="IFUGAO"
                                    class="mr-2 rounded border-gray-300 text-blue-600 focus:ring-blue-500">
                                <span class="text-sm">IFUGAO</span>
                            </label>
                            <label class="flex items-center">
                                <input type="checkbox" name="office[]" value="KALINGA"
                                    class="mr-2 rounded border-gray-300 text-blue-600 focus:ring-blue-500">
                                <span class="text-sm">KALINGA</span>
                            </label>
                            <label class="flex items-center">
                                <input type="checkbox" name="office[]" value="MT.PROVINCE"
                                    class="mr-2 rounded border-gray-300 text-blue-600 focus:ring-blue-500">
                                <span class="text-sm">MT.PROVINCE</span>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">
                                Universe <span class="text-red-500">*</span>
                            </label>
                            <div id="universeInputs" class="space-y-2">
                                <div class="text-xs text-gray-500">Select offices to see universe inputs</div>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div id="accomplishmentInputs" class="space-y-2">
                                <div class="text-xs text-gray-500">Select offices to see accomplishment inputs</div>
                            </div>
                        </div>

                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">
                                Yearly Targets (2024-2028)
                            </label>
                            <div id="targetInputs" class="space-y-2">
                                <div class="text-xs text-gray-500">Select offices to see target inputs</div>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div id="remarksInputs" class="space-y-2">
                                <div class="text-xs text-gray-500">Select offices to see remarks inputs</div>
                            </div>
                        </div>
                    </div>
...
<div id="deleteModal" class="fixed inset-0 bg-black bg-opacity-50 z-50 hidden flex items-center justify-center p-4">
    <div class="bg-white rounded-2xl shadow-2xl max-w-md w-full">
        ...
        <div class="p-6">
            <p class="text-gray-700 mb-6">Are you sure you want to delete this STO record? This action cannot be undone.
            </p>
